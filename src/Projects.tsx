...
"https://github.com/SherisseTJW/raytracingInAMonth/">
	...
	Compiler to Reversible Language (CTRL)
											...
											This project was completed as part of my Final Year Project (FYP) as a Computer Science Undergraduate in the National University of Singapore (NUS).
												<br></br>
												Specifically, I created a Proof-of-Concept (PoC) compiler to a reversible version of the x86lite assembly language to allow for the execution of logically reversible programs without incurring developer overhead.
											</p>
									</div>
							</div>
					</section>
